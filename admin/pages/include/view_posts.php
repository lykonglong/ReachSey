                ...
                <div class="box-body">
                    <form class="form-horizontal" method="post" action="" enctype="multipart/form-data" id="addMovieForm">
                        ...
                        <div class="box-footer" style="text-align: center;">
                            <a href="posts.php"> <button type="button" class="btn btn-danger"><i class="fa fa-close">&nbsp;</i>Back</button></a>
                            <a href="posts.php?action=edit_post&edit=<?php echo $post_id; ?>"> <button type="button" class="btn btn-success"><i class="fa fa-edit">&nbsp;</i>Edit</button></a>
                        </div>
                        <!-- /.box-footer -->
                    </form>
                </div>
