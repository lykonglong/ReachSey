...
<div class="container demo-2">
	<div class="content">
        <div id="large-header" class="large-header">
			<h1 class="header-w3ls">Sorry Proccessing Error</h1>

			<p class="w3-agileits1"><a href="/index">Back to home</a></p>
            <canvas id="demo-canvas"></canvas>
			<img src="/img/owl.gif" alt="flashy" class="w3l">
            <a href="/index"><h2 class="main-title">404</span></h2></a>
