<?php
    if(isset($_GET['cat_id'])){
        $the_cate_id=$_GET['cat_id'];
        $query="select * from categories where cat_id='$the_cate_id'";
    ...
    if(isset($_POST['btnupdate'])){
        $new_cate_name=mysqli_real_escape_string($connection,$_POST['cat_name']);
                            ...
                            <div class="box-body">
                                <!-- form start -->
                                    <div class="form-group">
                                        <label for="cat_name" class="col-sm-4 control-label" style="font-size: 16px;">Category Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" value="<?php echo $cat_name; ?>" name="cat_name" id="cat_name"  placeholder="Category Name" required>
                                        </div>
                                    </div>
